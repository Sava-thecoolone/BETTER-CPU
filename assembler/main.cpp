...
int main(int argc, char *argv[])
{
    ...
    std::ifstream input_file("%appdata%\\..\\LocalLow\\SebastianLague\\Digital-Logic-Sim\\Projects\\MUCH_BETTER_CPU\\Chips\\CPU.json");
    ...
    try
    {
        ...
        std::ofstream out_file("%appdata%\\..\\LocalLow\\SebastianLague\\Digital-Logic-Sim\\Projects\\MUCH_BETTER_CPU\\Chips\\CPU.json");
